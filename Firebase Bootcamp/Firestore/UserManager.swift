...
struct DBUser: Codable {
  ...
  //    let curentValue = isPremium ?? false
  //    isPremium = !curentValue
  //  }
...
final class UserManager {
  ...
  func updateUserProfieImagePath(userId: String, path: String?, url: String?) async throws {
    let data: [String: Any] = [
  ...
  func remvoveFavoriteMovie(userId: String) async throws {
    let data: [String: Any?] = [
